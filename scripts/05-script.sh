...
for i in 0 1 2; do
  ...
  scp -i $KEY_PATH -o "StrictHostKeyChecking no" admin.kubeconfig kube-controller-manager.kubeconfig kube-scheduler.kubeconfig ubuntu@$IP:~/
done
